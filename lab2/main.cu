...
int main(int argc, char **argv)
{
	...
	auto text_pos_head = GenerateTestCase(engine, 40000000); // 40 MB data 40000000
	...
	TestRoutine(yours1_mb, text_sync, n, 1, pos.data());
	TestRoutine(yours2_mb, text_sync, n, 2, pos.data());
